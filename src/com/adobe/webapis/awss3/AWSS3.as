...
package com.adobe.webapis.awss3
{
	...
	public class AWSS3 extends EventDispatcher
	{
		...
		private static const AMAZON_ENDPOINT:String = "s3.amazonaws.com";//"ap-southeast-1.queue.amazonaws.com"; //s3.amazonaws.com
		...
		//http://code.google.com/p/as3awss3lib/issues/detail?id=3#c1
		//http://www.cafesilencio.net/blog/amazon-s3-suport-in-adobe-air
	...
	/*	public function saveObject(bucketName:String, objectName:String, contentType:String, objectFile:File):void
		{
			...
			var req:URLRequest = getURLRequest("POST", "/" + escape(bucketName) + "/" + escape(objectName), contentType);
		...
		public function saveObject(bucketName:String, objectName:String, contentType:String, objectFile:File,acl:String = null):void
		{
			...
			var req:URLRequest = getURLRequest("POST", "/" + escape(bucketName) + "/" + escape(objectName), contentType,null,false,acl);
	...
	/*	private function getURLRequest(method:String, resource:String, contentType:String = null, hash:String = null, secure:Boolean = true):URLRequest
		...
		private function getURLRequest(method:String, resource:String, contentType:String = null, hash:String = null, secure:Boolean = false,acl:String = null):URLRequest
		{
			var protocol:String = (secure) ? "https" : "http";
			var req:URLRequest = new URLRequest(protocol + "://" + AMAZON_ENDPOINT + resource);
			req.cacheResponse = false;
