...
package com.fastforwardthinker.util.mp3
{
	...
	public class MP3InfoUtil
	{
		 ...
		 * 
		 */
		public static function getInfo( url:String, useStealthyHeaders:Boolean, responder:IResponder=null):void
		{
			...
			if(useStealthyHeaders)
			{
			 request = getStealthURLRequest(url);
			}
			else
			{
