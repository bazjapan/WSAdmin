package com.flexblocks.imagecropper {
	 ...
	 */ 
	[Event(name="sourceImageLoading",type="flash.events.Event")]
	
	
	/**
	 * This event is dispatched if an I/O error occurs while loading an image from a URL.
	 */ 
	[Event(name="sourceImageLoadError",type="flash.events.Event")]
	 ...
	 */ 
	[Event(name="sourceImageReady",type="flash.events.Event")]
	
	/**
	 * This event is dispatched whenever the cropping rectangle is resized or repositioned using the mouse.
	 */
	[Event(name="cropRectChanged",type="flash.events.Event")]
	 ...
	 */
	[Event(name="cropConstraintChanged",type="flash.events.Event")]
	 ...
	 */	
	[Event(name="cropConstraintDisabled",type="flash.events.Event")]
	 ...
	 */	
	[Event(name="cropPositionChanged",type="flash.events.Event")]
	 ...
	 */	
	[Event(name="cropDimensionsChanged",type="flash.events.Event")]
	...
	public class ImageCropper extends UIComponent {
		...
		public var cropRectUpdateCallback:Function;//moveType m or r + rect ex. (r,rect)
		...
		public static const SOURCE_IMAGE_LOADING:String = "sourceImageLoading";
		
		/**
		 * Constant value for the <code>sourceImageLoadError</code> event.
		 */
		
		public static const SOURCE_IMAGE_LOAD_ERROR:String = "sourceImageLoadError";
		
		/**
		 * Constant value for the <code>sourceImageReady</code> event.
		 */
		
		public static const SOURCE_IMAGE_READY:String = "sourceImageReady";
		
		/**
		 * Constant value for the <code>cropRectChanged</code> event.
		 */
		
		public static const CROP_RECT_CHANGED:String = "cropRectChanged";
		
		/**
		 * Constant value for the <code>cropConstraintChanged</code> event.
		 */
		
		public static const CROP_CONSTRAINT_CHANGED:String = "cropConstraintChanged";
		
		/**
		 * Constant value for the <code>cropConstraintDisabled</code> event.
		 */
		
		public static const CROP_CONSTRAINT_DISABLED:String = "cropConstraintDisabled";
		
		/**
		 * Constant value for the <code>cropPositionChanged</code> event.
		 */
		
		public static const CROP_POSITION_CHANGED:String = "cropPositionChanged";
		
		/**
		 * Constant value for the <code>cropDimensionsChanged</code> event.
		 */
		
		public static const CROP_DIMENSIONS_CHANGED:String = "cropDimensionsChanged";		
		...
		private function sourceLoadSuccess(event:Event):void {
			...
			imageBitmapData = Bitmap(LoaderInfo(event.currentTarget).content).bitmapData.clone();
		...
		private function doMouseMove(event:MouseEvent):void {
			...
			if (croppingRectBitmapData != null && event.buttonDown) {
				...
				if(activeHandle != -1)
				{
					var type:String = activeHandle==0?'m':'r';
					
					cropRectUpdateCallback(type,cropRect);
				}
